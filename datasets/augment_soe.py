...
# extreme sub-categories
#
# Example:
#   python augment_soe.py \
#     --infile filelists/soe/soe_wav-text_train.txt \
#     --outfile filelists/soe/3x/soe_wav-text_train_3x.txt \
#     --multi-factor 3 \
#     --verbose
#
...
def multiply_keyword_line(lines, keyword, r, verbose=False):
  ...
  if verbose:
    ...
    L = len(lines)
    print('Total #lines after {}x of lines with keyword "{}": {} ({}X{}+{})'.format(
      r, keyword, L, L1, r, L2))
  return lines
...
def main():
  ...
  # args.infile = 'filelists/soe/soe_wav-text_test.txt'
  # args.outfile = 'filelists/soe/3x/soe_wav-text_test_3x.txt'
